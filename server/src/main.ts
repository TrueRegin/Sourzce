...
async function bootstrap() {
    ...
    if (production) {
                ...
                console.log(
                    ...
                    chalk
                        ...
                        .bold.underline.italic(
                            `http://${process.env.SERVER_IP || LAN_IP}:${process
                                .env.PORT || DFT_PORT}`,
                        ),
                );
            },
        ...
        await app.listen(process.env.PORT || DFT_PORT, () => {
            console.log(
                chalk.whiteBright(`Sourzce server started on `),
                chalk
                    .bgHex('#ff2b75')
    ...
    if (LAN_IP && process.env.SERVER_IP) {
        console.log(
            chalk.bgYellow.whiteBright(
                "Note, in V 1.1.2+ of Sourzce you don't need to define SERVER_IP in .env, the server automatically gets it for you! Remove SERVER_IP to remove this message.",
            ),
        );
    }
}
